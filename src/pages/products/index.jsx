...
import ListModal from "../../components/products/ListModal";
...
const ProductListPage = () => {
  ...
  const rowCells = (row, idx) => [
    idx + 1,
    row.productName,
    <Button variant="contained" onClick={() => handleOpenListModal(row.productId)}>
      추가
    </Button>,
  ];
